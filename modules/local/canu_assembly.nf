...
process assembleCore_canu {
    ...
    """
    ############################################################
    # Internal retries from the beginning (trim -> downsample -> ...)
    ############################################################
    ...
    while [ \\$attempt -le \\$max_attempts ]; do
        ...
        ############################################################
        # Downsampling (per-attempt now; this is likely where ND was coming from)
        ############################################################
        ...
        # Record downsample checksum so we can confirm ND across attempts
